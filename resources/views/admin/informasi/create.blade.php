    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Add Informasi</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Add Informasi</li>
                    </ol>
                </div>
            </div>
        </div>
      ...
      <div class="col-12">
          <div class="card">
              <div class="card-body">
                ...
                <h4 class="card-title">Add Informasi </h4>
                ...
                <form method="post" action="{{ route('admin.informasi.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="judul_informasi" class="form-control" type="text" value="{{ old('judul_informasi') }}" id="judul_informasi">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="deskripsi_informasi" id="elm1" cols="30" rows="10">{{ old('deskripsi_informasi') }}</textarea>
                    ...
                    <input type="submit" class="btn btn-info waves-effect waves-light" value="Insert Informasi Data">
                  </form>
