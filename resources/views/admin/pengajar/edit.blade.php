    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Edit Pengajar</h4>
              ...
              <div class="card-body">
                ...
                <form method="post" action="{{ route('admin.pengajar.update', $pengajar->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="nama_pengajar" class="form-control" type="text" value="{{ $pengajar->nama_pengajar }}" id="nama_pengajar">
                            @error('nama_pengajar')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="jabatan_pengajar" class="form-control" type="text" value="{{ $pengajar->jabatan_pengajar }}" id="jabatan_pengajar">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="motivasi_pengajar" class="form-control" type="text" value="{{ $pengajar->motivasi_pengajar }}" id="motivasi_pengajar">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="bio_pengajar" class="form-control" cols="30" rows="10">{{ $pengajar->bio_pengajar }}</textarea>
                            @error('bio_pengajar')
                                <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <img id="showImage" class="img-fluid img-thumbnail" src="{{ asset($pengajar->gambar_pengajar) }}" alt="Image Show">
                        </div>
                    </div>
                    <!-- end row -->


                    <input type="submit" class="btn btn-info waves-effect waves-light" value="Update Pengajar Data">
                  </form>
