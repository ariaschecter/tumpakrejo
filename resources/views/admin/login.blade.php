                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="{{ url('/') }}" class="auth-logo">
                                    <img src="{{ asset('frontend/image/logo/logo.png') }}" class="logo-dark mx-auto" alt="" width="200px">
                                    <img src="{{ asset('frontend/image/logo/logo.png') }}" class="logo-light mx-auto" alt="" width="200px">
                                </a>
                            </div>
                        </div>
