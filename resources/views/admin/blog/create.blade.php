              ...
              <div class="card-body">
                ...
                <form method="post" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <select class="form-select" aria-label="Default Select Example" name="kategori_blog" id="kategori_blog">
                                    <option value="kegiatan" {{ 'kegiatan' == old('kategori_blog') ? 'selected' : '' }}>KEGIATAN SEKOLAH</option>
                                    <option value="prestasi" {{ 'prestasi' == old('kategori_blog') ? 'selected' : '' }}>PRESTASI</option>
                                    <option value="ekstra" {{ 'ekstra' == old('kategori_blog') ? 'selected' : '' }}>EKSTRAKURIKULER</option>
                            </select>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="judul_blog" class="form-control" type="text" value="{{ old('judul_blog') }}" id="judul_blog">
                            @error('judul_blog')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="deskripsi_blog" id="elm1" cols="30" rows="10">{{ old('deskripsi_blog') }}</textarea>
