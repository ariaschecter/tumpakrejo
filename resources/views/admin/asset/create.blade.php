              ...
              <div class="card-body">
                ...
                <form method="post" action="{{ route('admin.asset.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input name="judul_asset" class="form-control" type="text" value="{{ old('judul_asset') }}" id="judul_asset">
                            @error('judul_asset')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea name="deskripsi_asset" class="form-control" cols="30" rows="10">{{ old('deskripsi_asset') }}</textarea>
                    ...
                    <input type="submit" class="btn btn-info waves-effect waves-light" value="Insert Asset Data">
                  </form>
